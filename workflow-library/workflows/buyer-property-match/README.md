...
Match qualified buyers to new/updated listings and rank by fit.

**Department:** Real Estate Brokerage  
**Trigger:** Schedule (daily)  
**Agent Skills:** qualifying-buyers

## The Claude step (prompt)
```
Given these active buyers and available listings, produce ranked matches per buyer (fit score + why), respecting budget and eligibility. Return {"matches":[{"buyer":"...","listing":"...","score":0,"why":"..."}]}. A licensed broker/agent (and the client's lawyer) reviews before anything is listed, offered, signed, or transferred; money moves only through proper escrow/solicitor accounts with human authorisation; confirm the jurisdiction's rules.
```
